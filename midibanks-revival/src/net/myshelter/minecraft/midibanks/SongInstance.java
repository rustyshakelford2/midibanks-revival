...
/*     */         continue;
/*  80 */       ArrayList relBlocks = new ArrayList();
/*  81 */       int channel = 0;
...
/*     */         {
/* 112 */           Integer iaux11;
/* 112 */           if ((midiNote >= keyNote) && (midiNote < keyNote + 24)) { iaux11 = Integer.valueOf(midiNote - keyNote);
/*     */           }
/*     */           else
/*     */           {
/* 113 */             Integer iaux111;
/* 113 */             if ((this.repOctave) && (midiNote < keyNote)) { iaux111 = Integer.valueOf((midiNote - 6) % 12);
/*     */             }
/*     */             else
/*     */             {
/* 114 */               Integer iaux1111;
/* 114 */               if ((this.repOctave) && (midiNote >= keyNote + 24)) iaux1111 = Integer.valueOf(12 + (midiNote + 6) % 12); else
